            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                if (newText != null) {
                    ...
                    if (viewPager2 != null && viewPager2.currentItem == 0) {
                        ...
                        Log.d(TAG, "ChildFragment ki? : $childFragment")
                        ...
                        Log.d(TAG, "ChildFragment ki? : $childFragment")
                        val adapter =
                            childFragment?.recyclerView_entertainment?.adapter as NewsAdapter?
                        adapter?.performSearch(newText)
                        return true
                        ...
                        Log.d(TAG, "ChildFragment ki? : $childFragment")
                        val adapter =
                            childFragment?.recyclerView_technology?.adapter as NewsAdapter?
                        adapter?.performSearch(newText)
                        return true
                    }
                }
